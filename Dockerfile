...
RUN \
  ...
  && . /etc/profile \
  && mkdir -p /code/mirai/mcl/config/net.mamoe.mirai-api-http \
  && cat /code/config/mirai-api-http-setting.yml > /code/mirai/mcl/config/net.mamoe.mirai-api-http/setting.yml \
